...
_Last updated: 25 September 2026 (with release 1.20.0, awaiting merge)._
...
234 unit tests (Vitest) and 45 browser tests (Playwright) pass; `npm run check` (types, lint, format, unit tests,
build) is green.
