...
_Last updated: 25 September 2026 (with release 1.21.0, awaiting merge)._
...
| --- | --- |
| 1.21.0 | Awaiting merge. Dockable tool bars: each tool section is its own bar with a grip; drag it (or right-click the grip) to dock at the left, right, top or bottom, next to other bars; left/right columns wrap into more columns instead of scrolling; layout remembered; View › Reset tool bars |
